...
<br />
<br />
<input type="text" className="form-control" style={{height:"150px", width:"150px",textAlign:"center",display: buttonShow===false ? 'none' : ''}} onChange={(e)=>setmegjegyzes(e.target.value)} placeholder="Megjegyzés" />
<br />
<br />
