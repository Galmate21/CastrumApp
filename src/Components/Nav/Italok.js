                      ...
                      <hr className='HR2'></hr>
                       ...
                       <Card.Text>
                           ...
                           <ListGroup style={{ textAlign: "center" }} className="list-group-flush">
                               <ListGroupItem ><Nav.Link href="/Szorpok"><button className=" btn-danger buttonStyle">Szörpök</button></Nav.Link></ListGroupItem>
                               <ListGroupItem ><Nav.Link href="/Borok"><button className=" btn-danger buttonStyle">Borok</button></Nav.Link> </ListGroupItem>
                               <ListGroupItem ><Nav.Link href="/Sorok"><button className=" btn-danger buttonStyle">Sörök</button></Nav.Link> </ListGroupItem>
                               <ListGroupItem ><Nav.Link href="/Palinkak"><button className=" btn-danger buttonStyle">Pálinkák</button></Nav.Link> </ListGroupItem>
                               <ListGroupItem ><Nav.Link href="/Kavek"><button className=" btn-danger buttonStyle">Kávék</button></Nav.Link> </ListGroupItem>
                               <ListGroupItem ><Nav.Link href="/Egyeb"><button className=" btn-danger buttonStyle">Egyéb</button></Nav.Link> </ListGroupItem>
