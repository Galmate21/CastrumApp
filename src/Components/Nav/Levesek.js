...
const [levesf,setlevesf]=useState("")
    

    useEffect(()=>{
        axios({
          method: 'get',
          url: 'https://hidden-coast-90775.herokuapp.com/foods/Leves',
          responseType: 'json'
        })
          .then((response)=> {
    ...
    const AddToCart=function(name,info,ar,f,t){
  ...
  <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
        ...
        <Modal show={show} onHide={handleClose} animation={true}>
                    ...
                    <Modal.Body style={{height:"350px"}} > 
                            <h1 className="text-center">{leves} {levesf}</h1>
                            <hr className='HR2'></hr>
                           {foodInfo.map((v,i)=>{
                               return(
                           ...
                           <button onClick={felAdag} className="btn btn-info">Fél adag</button>

                    <h5 style={{marginTop:"75px"}}>Hozzáadható:</h5>
...
<button type="button" onClick={Descrease}  className="btn btn-outline-danger rounded-circle"><svg xmlns="http://www.w3.org/2000/svg" width="45" height="55" fill="currentColor" class="bi bi-dash" viewBox="0 0 16 16">
  <path d="M4 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 4 8z"/>
                           ...
                           <button className='btn btn-danger' onClick={()=>AddToCart(leves+levesf,foodInfo,food.Price,levesf,food.Type)} style={{marginTop:"18px"}}>Hozzáadás</button>
