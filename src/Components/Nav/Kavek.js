...
function Kavek() {
    ...
    useEffect(()=>{
        axios({
          method: 'get',
          url: 'https://hidden-coast-90775.herokuapp.com/foods/Kave',
          responseType: 'json'
        })
          .then((response)=> {
    ...
    const AddToCart=function(name,info,ar){
...
<button type="button" onClick={Descrease}  className="btn btn-outline-danger rounded-circle"><svg xmlns="http://www.w3.org/2000/svg" width="45" height="55" fill="currentColor" class="bi bi-dash" viewBox="0 0 16 16">
  <path d="M4 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 4 8z"/>
                           ...
                           <button className='btn btn-danger' onClick={()=>AddToCart(food.name,foodInfo,food.Price)} style={{marginTop:"18px"}}>Hozzáadás</button>
